...
# App
# =========================
st.set_page_config(page_title="Temperatura da Pauta — Pro v6", page_icon="🔥", layout="wide")
st.title("🔥 Temperatura da Pauta — Pro v6")
...
# Google Trends (skip first 2 rows automatically)
st.subheader("Google Trends — Últimos 15 dias")
@st.cache_data(show_spinner=False)
def parse_trends_csv(file) -> pd.DataFrame:
    # Skip the first 2 rows that Google Trends adds as metadata/header notes
    ...
    # pick first numeric column as 'Volume'
...
st.markdown("---")
st.caption("Creative Data • Temperatura da Pauta — Pro v6 (skiprows=2 no Trends + thresholds)")
